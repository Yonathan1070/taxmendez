...
<div class="col-md-12 col-xlg-12">
    <div class="card">
        <div class="card-header">
            ...
            <h4 class="card-title m-b-0">{{Lang::get('messages.EditNotificationChannel')}}</h4>
        </div>
        <div class="card-body collapse show b-t">
            ...
            @endif
            <form class="m-t-40" action="{{route('actualizar_canal_notificacion', ['id' => Crypt::encrypt($canal->id)])}}" method="POST" novalidate>
                @method('PUT')
