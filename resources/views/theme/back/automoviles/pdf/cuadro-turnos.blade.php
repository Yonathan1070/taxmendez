        ...
        <table style="width: 100%; text-align:center; display: inline-table; float: left;" cellpadding="0" cellspacing="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="color: red; border:1px solid red; border-bottom:0;">
                    ...
                    @if (sizeof($gastos) > 0 && $gastos[0])
                        ...
                        <td style="border:1px solid red; border-bottom:0;">
                            {{'$'.number_format($gastos[0]->GST_Costo_Gasto, 0, ',', '.')}}
                        </td>
                    @else
                ...
                <tr>
                    <td style="border:1px solid red; border-top:0; border-bottom:0;">
                ...
                <tr>
                    <td rowspan="2" style="border:1px solid red; border-top:0; border-bottom:0;">
                ...
                <tr>
                    ...
                    @else
                        <td style="border:1px solid red; border-top:0; border-bottom:0;"></td>
                        <td style="border:1px solid red; border-top:0; border-bottom:0;"></td>
                    @endif
