...
<div class="col-md-12 col-xlg-12">
    <div class="card">
        <div class="card-header">
            ...
            <h4 class="card-title m-b-0">{{Lang::get('messages.AddCompany')}}</h4>
        </div>
        <div class="card-body collapse show b-t">
            ...
            @endif
            <form class="m-t-40" action="{{route('guardar_empresa')}}" method="POST" enctype="multipart/form-data" novalidate>
